          ...
          <div className="relative max-w-xl mx-auto px-4 md:px-6 lg:px-8 lg:max-w-screen-xl">
            <div className="relative">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-description">
                ContentGenie is a powerful framework for automating content creation. It simplifies video creation, footage sourcing, voiceover synthesis, and editing tasks.
              </p>
            </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-base leading-6 text-description">
                        ContentGenie streamlines the video creation process with an LLM oriented video editing language, making it easier to automate editing tasks.
                      </p>
                    </div>
                  </div>
                </li>
                <li className="mt-10 lg:mt-0">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-base leading-6 text-description">
                        ContentGenie supports multiple languages for voiceover synthesis, making it easy to create content in various languages.
                      </p>
                    </div>
                  </div>
                </li>
                <li className="mt-10 lg:mt-0">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-base leading-6 text-description">
                        ContentGenie can source images and video footage from the internet, allowing you to easily find and use relevant visuals.
                      </p>
                    </div>
                  </div>
                </li>
          ...
          <div className="diagonal-content max-w-xl mx-auto px-4 md:px-6 lg:px-8 lg:max-w-screen-xl">
            <div className="max-w-screen-xl mx-auto pt-6 px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                ...
                ContentGenie is an AI-powered framework that automates the process of content creation, from script generation to asset sourcing and video editing.
                </p>
              </div>
            </div>
                ...
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                  <div>
                    ...
                    <div className="mt-10 lg:mt-0 p-4">
                      ...
                      ContentGenie employs a heavy usage of LLMs and automated video editing libraries to streamline the video creation process (Ffmpeg, moviepy, ffprobe).
                      </p>
                    </div>
                  </div>
                  <div className="mt-10 lg:mt-0 p-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-base leading-6 text-gray-600">
                      ContentGenie uses EdgeTTS for free multilingual voice synthesis in generated audio.
                      </p>
                    </div>
                  </div>
                  <div className="mt-10 lg:mt-0 p-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-base leading-6 text-gray-600">
                      ContentGenie supports configured background assets and generated image overlays for short-form content.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-2 text-base leading-6 text-gray-300">
                          ContentGenie automates the video editing process, making it faster and more efficient with the help of AI.
                        </p>
                      </div>
                    </div>
                  </li>

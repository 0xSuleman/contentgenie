...
from contentgenie.editing_framework.core_editing_engine import CoreEditingEngine
...
class EditingStep(Enum):
    ...
    ADD_CAPTION_POP = "make_caption_pop.json"
...
class EditingEngine:
    ...
    def addEditingStep(self, editingStep: EditingStep, args: Dict[str, any] = None):
        args = args or {}
...
# STEPS_PATH = "contentgenie/editing_framework/editing_steps/"
# FLOWS_PATH = "contentgenie/editing_framework/flows/"

from contentgenie.utils.requirements import Requirements
...
class CLI:
    ...
    def display_header():
        ...
        CLI.display_green_text("ContentGenie")
        CLI.display_green_text("Automated short-form video generation and editing.")
        print("")
    ...
    def display_help():
        '''Display help'''
        print("Usage: python contentgenie.py [options]")
        print("")
        print("Options:")
    ...
    def display_error(error_message, stack_trace):
        ...
        print(stack_trace)
        print("If the problem persists, check the server logs for more details.")

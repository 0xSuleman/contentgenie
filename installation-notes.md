** Thanks for Son Tran for the fixes on the installation guide. Here are the recommanded steps for installing ContentGenie:


### You now need Docker to now run ContentGenie. If you can't run it with docker, please use the Google Colab.
# To run ContentGenie docker:
...
- Python 3.10
- whisper timestamping dependencies
- ffmpeg 4.2.3
...
ContentGenie will accept this version of FFmpeg:
...
### 4. Install whisper timestamping dependencies:
```bash
pip3.10 install -U whisper-timestamped
```
